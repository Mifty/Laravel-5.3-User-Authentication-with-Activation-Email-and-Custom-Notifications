    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <p>This is a demo application that goes along with my tutorial on <a href="http://miftyisbored.com/a-complete-auth-with-activation-key-tutorial-in-laravel-5_3">authentication in Laravel 5.3.</a> You can play around with the application, view the source code on GitHub or follow along the <a href="http://miftyisbored.com/a-complete-auth-with-activation-key-tutorial-in-laravel-5_3">tutorial</a>.</p>
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
				...
				<p>The code that builds this app is explained in <a href="http://miftyisbored.com/a-complete-auth-with-activation-key-tutorial-in-laravel-5_3">this tutorial</a>. You can follow the tutorial or fork the code on <a href="http://github.com/mifty" target="_blank" >GitHub</a>.</p>
                <a href="http://miftyisbored.com/a-complete-auth-with-activation-key-tutorial-in-laravel-5_3" class="btn btn-success btn-xl sr-button"><i class="fa fa-magic "></i> View the Tutorial!</a> 
				<a href="http://github.com/mifty" target="_blank" class="btn btn-primary btn-xl sr-button"><i class="fa fa-github "></i> View the Code on GitHub</a>
            </div>
        </div>
    </aside>
